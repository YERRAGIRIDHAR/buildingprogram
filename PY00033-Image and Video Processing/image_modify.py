...
img = cv2.imread("kangaroos-rain-australia.jpg",0)
...
cv2.imshow("G5_image", resized_image) # for disply resized image
cv2.imwrite("G5_image.jpg",resized_image) # for creating resized image
