...
df = pandas.DataFrame(columns=["Start","End"]) # record the data
...
while True:
    ...
    gray = cv2.GaussianBlur(gray,(21,21),0) # increase the accuracy
    ...
    cv2.imshow("Gray Frame", gray)#created a window with name Capturing name and hoding first frame
